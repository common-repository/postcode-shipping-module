...
<?php
	...
	function submit_form() {
		...
		$new_layers = array();
		//1.4.0 
		$filter_wpsc_shipping_postcoderate_layer = sanitize_text_field($_POST['wpsc_shipping_postcoderate_layer']);
		$layers = (array)$filter_wpsc_shipping_postcoderate_layer;
		
		$filter_wpsc_shipping_postcoderate_shipping = sanitize_text_field($_POST['wpsc_shipping_postcoderate_shipping']);
		$shippings = (array)$filter_wpsc_shipping_postcoderate_shipping;
	...
	function getQuote() {
		...
		if(isset($_POST['zipcode'])) 
		{
		    ...
		    $_SESSION['wpsc_zipcode'] = $destzipcode;
		    /*
		...
		{
		    //1.4.0 
		    $destzipcode = sanitize_text_field($_SESSION['wpsc_zipcode']);
